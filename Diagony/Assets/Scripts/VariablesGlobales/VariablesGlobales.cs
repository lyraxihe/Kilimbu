...
public class VariablesGlobales : MonoBehaviour
{
    ...
    public List<int> CardCostOriginal = new List<int>() { 1, 1, 2, 2, 3, 3, 0, 1, 2, 2, 3, 3, 5, 1, 0, 1, 2, 1, 0, 2, 1, 0, 4, 1 };
    public List<int> CardCost = new List<int>() { 1, 1, 2, 2, 3, 3, 0, 1, 2, 2, 3, 3, 5, 1, 0, 1, 2, 1, 0, 2, 1, 0, 4, 1 };
